...
export const BankAccountPinModel = ({
  classes,
  visible,
  setVisible,
  onClick,
        ...
        <div className="dialogbody flex flex-col gap-4">
          <div className="flex flex-col">
            <p className="text-[12px] font-[600] mx-auto">
              Enter Your Last Bank Account Pin
            </p>
          </div>
          <div className="flex gap-3 text-center mx-auto mt-[31px]">
            <InputTxt
              ...
              placeholder="-"
              inputClasses="!text-[20px] !w-full"
              Title={Code}
              MainClasses="!w-[50px] !pl-[10px] !pr-[0px]  !h-[54px] !border !rounded-[10px] !bg-[#FFFFFF] m-auto"
            />
            <InputTxt
              type="text"
              maxLength="1"
          ...
          <CustomButton
            onClick={onClick}
            txt={'VERIFY'}
            classes={`!w-[126px] !h-[50px] !mx-auto !mt-[25px] !rounded-[10px]  `}
          />
        </div>
      </CustomDialog>
    </>
