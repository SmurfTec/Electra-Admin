      ...
      <div className="dialogbody flex flex-col gap-4 px-[49px]">
        <div className="flex gap-3">
          ...
          <InputTxt
            ...
            Title={values.AccountHolder}
            onChange={(e: any) =>
              setValues({ ...values, AccountHolder: e.target.value })
            }
        ...
        <div className="flex gap-3">
          ...
          <InputTxt
            ...
            Title={values.RoutingNumber}
            onChange={(e: any) =>
              setValues({ ...values, RoutingNumber: e.target.value })
            }
            MainClasses="!w-[370px] !h-[54px] !border !rounded-[10px] !bg-[#FFFFFF] m-auto"
          />
        </div>
        ...
        <div className="flex flex-col justify-start gap-5 mt-[20px]">
          ...
          <div className="flex gap-3">
            <CustomButton
              txt="Current"
              classes="!w-[118px] !h-[50px] !bg-[#E2E2E2] !rounded-[10px] !text-black !text-[16px]"
            />
            <CustomButton
              txt="Saving"
              onClick={() => {}}
              classes={`!w-[118px] !h-[50px]  !rounded-[10px] !text-white !text-[16px]`}
            />
          </div>
        </div>
