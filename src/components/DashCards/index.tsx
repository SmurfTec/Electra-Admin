...
export const DashCard = (props: MyProps) => {
  return (
    <div
      ...
      className={`${props.outerclasses} w-[300px] h-[136px] overflow-hidden bg-[#FCFCFC] rounded-[8px]  `}
    >
      {props?.Add ? (
        ...
        <div className="flex justify-between pt-[16px] px-[16px] pb-[12px]">
          <div className="px-2  pt-1 ">
            <p className={`text-[13px] font-[600] ${props.titleStyle}`}>
              {props.title}
            </p>
            <h1
              className={`text-[28px] font-[700] mt-[2px] ${props.Numberstyle}`}
            >
              {props.totalNumber}
            </h1>
          ...
          <div
            className={`${props.imgColor}  h-[30px] w-[30px] rounded flex justify-center mt-2`}
          >
