...
export const Category = () => {
  ...
  const { CategoryData, CategoryLoading, stats } =
    useFetchCategories(initialPageData1);
  const { VariantData, VariantLoading, Variantstats } =
    useFetchVariants(initialPageData2);
      ...
      const [items] = useState([
        ...
        },
        {
          ...
          template: (item: MenuItem) => {
            return (
              <div
                onClick={event => deleteCategoryItem(event, rowData.id)}
      ...
      const [items] = useState([
        {
          ...
          template: (item: MenuItem) => {
            return (
              <div
                onClick={event => deleteVariantItem(event, rowData.id)}
                style={{ background: 'rgba(231, 29, 54, 0.05)' }}
                className="flex w-full gap-1  items-center  text-[10px] font-[400] text-[#E71D36]"
              >
                <SVGIcon fillcolor={'#E71D36'} src={IMAGES.Delete} /> Delete
  ...
  return (
    <div>
      <SuccessModel
        ...
        txt="Category Deleted Successfully"
      />
      <SuccessModel
        visible={Variantvisible}
        setVisible={setVariantvisible}
        txt="Variant Deleted Successfully"
      />
