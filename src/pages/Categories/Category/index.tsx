    ...
    return (
        <div>
            ...
            <div className='mt-[35px]'>
                <div className='flex flex-wrap md:gap-[2rem] lg:gap-[2rem] xl:gap-[8rem] mt-[28px]'>
            ...
            <div className='mt-[20px] flex flex-wrap gap-[21px]'>
                <div className='flex flex-col gap-4 border border-lightgray rounded-[10px] pt-[21px] '>
                    ...
                    <CustomTableComponent
                        ...
                        MultipleSelect={true}
                    />
                    <div className='flex justify-center items-center -mt-[10px] pb-3 font-[500] text-[#B4B4B4]'>View More</div>
                </div>
                <div className='flex flex-col gap-4 border border-lightgray rounded-[10px] pt-[21px]'>
                    <div className='flex justify-between pl-[14px]   pr-[10px]'>
