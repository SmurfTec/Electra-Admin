...
navigate('/Dashboard')
  ...
  return (
    <div className='min-h-[100vh] w-[100vw] flex flex-col items-center pt-[90px]'>
        ...
        <CustomButtom txt="Login" classes='mt-[41px]' onClick={Login}/>
        ...
        <p className='text-[22px] mt-[150px] text-center font-[500] text-midgray'>Dont have an account? <Link className='text-blue' to="/">Signup</Link></p>
    </div>
  )
}
