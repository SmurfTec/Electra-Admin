...
import { getVerficationById,UpdateVerfication } from '../../../store/Slices/VerificationSlice';
...
export const ItemVerification = () => {
    ...
    const FinishVerification=async()=>{
        newFormData.append(`order_verification_details[0][id]`,String(itemData[0]?.id))
        newFormData.append(`order_verification_details[0][is_pass]`,state.crackswitch)
        newFormData.append(`order_verification_details[1][id]`,String(itemData[1]?.id))
        newFormData.append(`order_verification_details[1][is_pass]`,state.serialswitch)
        newFormData.append(`order_verification_details[2][id]`,String(itemData[2]?.id))
        newFormData.append(`order_verification_details[2][is_pass]`,state.batteryswitch)
        newFormData.append(`order_verification_details[3][id]`,String(itemData[3]?.id))
        newFormData.append(`order_verification_details[3][is_pass]`,state.lightswitch)
        newFormData.append(`order_verification_details[4][id]`,String(itemData[4]?.id))
...
<CustomInputTextArea placeholder="Enter Reason For Failure" cols={69}/>
         ...
         <UploadPicture setImages={setImages} images={images} multipleImages={true}/>
