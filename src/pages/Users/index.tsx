...
export const Users = () => {
  ...
  const [columnData]=useState([
    ...
    {field:"firstname",header:'First Name' ,body:''},
    {field:"lastname",header:'Last Name' ,body:''},
    {field:"email",header:'Email' ,body:''},
    {field:"phone",header:'Phone' ,body:''},
    {field:"register",header:'Registered On' ,body:''},
    {field:"status",header:'Status' ,body:StatusBodyTemplate},
    {field:"registerValue",header:'Registered Via' ,body:''},
