...
export const CreateBrand = () => {
  ...
  return (
    <div>
      <SuccessModel visible={successVisible} setVisible={setsuccessVisible} txt="Brand Created Successfully" />
       <Header
      ...
      <div className='mt-[27px]'>
        ...
        <CustomButton onClick={(value:any)=>navigate('/Brand')} txt="Cancel" classes="!w-[179px] !h-[50px] !rounded-[10px] !bg-custome-button-grey !text-black"  />
        <CustomButton txt="Create Brand" classes="!w-[179px] !h-[50px] !rounded-[10px] " onClick={Create}  />
        </div>
      </div>
    </div>
  )
