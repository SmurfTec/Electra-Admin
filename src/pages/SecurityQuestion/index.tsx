...
event.preventDefault();
  ...
  return (
    <div className="min-h-[100vh] w-[100vw] flex flex-col items-center pt-[90px]">
      ...
      <CustomDropdown options={options} value={"What was your childhood nickname?"} mainclasses="!mt-[30px] !bg-white !w-[39rem]" placeholdercolor="#9C9C9C" placeholder="Select Security Question"/>
      <InputTxt
