...
export const Settings = () => {
    ...
    const [twoFactorAuth, settwoFactorAuth] = useState(userdata?.profile?.is_two_step_verification_enabled || false)
    const [Notifications, setNotifications] = useState(userdata?.profile?.receive_notifications || false)
    const [MaintainaceMode, setMaintainaceMode] = useState(userdata?.profile?.maintenance_mode || false)
        ...
        <div>
            ...
            <div className='mt-[63px]'>
                ...
                <div className='flex justify-between w-[94%] mt-[20px] ml-[10px]'>
                    ...
                    <div className=''>
                        <CustomSwitch checked={MaintainaceMode} setChecked={setMaintainaceMode} />
                    </div>
                </div>
            </div>
        </div>
