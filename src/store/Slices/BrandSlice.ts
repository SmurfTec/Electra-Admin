...
export const getBrands = async () => {
  try {
    const response: any = await url.get(`/brands/?sort=id`);
...
export const GetBrandID = async (id: any) => {
  try {
    const response: any = await url.get(`/brands/${id}`);
    return response.data;
  } catch (e) {
    return e;
  }
...
export const CreateNewBrand = async (body: any) => {
  try {
    const response: any = await url.post('/brands', body);
    return response.data;
  } catch (e) {
    return e;
  }
...
export const EditBrandByID = async (id: string | number, body: any) => {
  try {
    const response: any = await url.put(`/brands/${id}`, body);
    return response.data;
  } catch (e) {
    return e;
  }
...
export const DeleteBrand = async (id: any) => {
  try {
    const response: any = await url.delete(`/brands/${id}`);
    return response.data;
  } catch (e) {
    return e;
  }
